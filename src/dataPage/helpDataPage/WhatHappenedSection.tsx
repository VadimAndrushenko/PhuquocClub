...
import { whatHappenedData, type WhatHappenedCardData } from './whatHappenedData'

interface WhatHappenedSectionProps {
  className?: string
  containerClass?: string
  cards?: WhatHappenedCardData[]
}

export default function WhatHappenedSection({
  className = '',
  containerClass = '',
  cards = whatHappenedData,
  ...
  return (
    ...
    >
      ...
      {/* Grid с карточками - 3 колонки на десктопе, 2 на планшете, 1 на мобильном */}
