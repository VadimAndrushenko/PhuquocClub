...
export default function Logo({smallLogo = false, locale = 'ru'} : {smallLogo?: boolean; locale?: string}) {
    return (
        <Link href={withLocale('/', locale)} className="flex items-center gap-2 font-bold text-lg">
